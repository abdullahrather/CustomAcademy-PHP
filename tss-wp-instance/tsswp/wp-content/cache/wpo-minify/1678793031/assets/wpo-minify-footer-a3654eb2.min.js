...
var elementorAppConfig = {"menu_url":"https:\/\/thescienceschool.edu.pk\/tsswp\/wp-admin\/admin.php?page=elementor-app&ver=3.1.4#site-editor\/promotion","assets_url":"https:\/\/thescienceschool.edu.pk\/tsswp\/wp-content\/plugins\/elementor\/assets\/","return_url":"https:\/\/thescienceschool.edu.pk\/tsswp\/wp-admin\/","site-editor":[]};/*! elementor - v3.1.4 - 10-03-2021 */
...
(function($){"use strict";var WidgetTestimonialCarouselHandler=function($scope,$){var carousel_elem=$scope.find('.htmega-testimonial-activation').eq(0);if(carousel_elem.length>0){carousel_elem[0].style.display='block'}
...
var WidgetCounterHandler=function($scope,$){var count_elem=$scope.find('.htmega-counter-number').eq(0);count_elem.counterUp({delay:10,time:1000,})}
